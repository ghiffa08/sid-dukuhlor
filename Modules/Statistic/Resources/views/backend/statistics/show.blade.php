    ...
    <div class="card-body">
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                <a href="{{ route('backend.statistics.edit', $$module_name_singular->id) }}"
                    class="btn btn-sm btn-primary"
                    data-toggle="tooltip"
                    title="Edit {{ $module_title }}">
                    <i class="fas fa-wrench"></i> Edit
                </a>
                <a href="{{ route('frontend.statistik.show', $$module_name_singular->slug) }}"
            ...
            <div class="col">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <p>{{ number_format($$module_name_singular->value, 0, ',', '.') }}</p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Satuan:</label>
                        <p>{{ $$module_name_singular->unit ?? '-' }}</p>
                    </div>
                </div>
