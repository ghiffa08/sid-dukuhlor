...
namespace Modules\Transparansi\Http\Controllers\Backend;
...
class TransparansiController extends BackendBaseController
{
    use Authorizable;
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'transparansi::backend';
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'slug' => 'required|string|unique:transparansi_budgets,slug',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'title' => 'required|string|max:255',
            'slug' => 'required|string|unique:transparansi_budgets,slug,' . $id,
            'category' => 'required|string',
            'value' => 'required|integer',
            'unit' => 'nullable|string|max:50',
            'icon' => 'nullable|string|max:100',
