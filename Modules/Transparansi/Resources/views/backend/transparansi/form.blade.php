                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        <div class="form-group">
                             ...
                             $field_placeholder = 'Contoh: Pendapatan Asli Desa';
                             $required = 'required';
                             ?>
                             {{ html()->label($field_label, $field_name)->class('form-label')->for($field_name) }}
                             {!! field_required($required) !!}
                             {{ html()->text($field_name)->class('form-control')->placeholder($field_placeholder)->attributes(["$required"]) }}
                        </div>
                     </div>
                </div>
