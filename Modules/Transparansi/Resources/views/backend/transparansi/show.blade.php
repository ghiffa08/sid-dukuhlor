    ...
    <div class="card-body">
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                <a href="{{ route('backend.transparansi.edit', $$module_name_singular->id) }}"
                    class="btn btn-sm btn-primary"
                    data-toggle="tooltip"
                    title="Edit {{ $module_title }}">
                    <i class="fas fa-wrench"></i> Edit
                </a>
                <a href="{{ route('frontend.transparansi.show', $$module_name_singular->slug) }}"
        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <p>{{ $$module_name_singular->category }}</p>
                </div>

                <div class="row">
                    <div class="col-md-3 mb-3">
                        <label class="form-label fw-bold">Tahun:</label>
                        <p>{{ $$module_name_singular->year }}</p>
                    </div>
                    <div class="col-md-3 mb-3">
                     ...
                     <div class="col-md-3 mb-3">
                        ...
                        <p>Rp {{ number_format($$module_name_singular->budget, 0, ',', '.') }}</p>
                    </div>
                     <div class="col-md-3 mb-3">
                        <label class="form-label fw-bold">Realisasi:</label>
                        <p>Rp {{ number_format($$module_name_singular->realization, 0, ',', '.') }}</p>
                    </div>
                </div>
                ...
                <hr class="my-4">
                <h5 class="fw-bold mb-3"><i class="fas fa-search"></i> Metadata SEO</h5>
                ...
                <div class="mb-3">
                    ...
                    <p>
                        @if($$module_name_singular->meta_keywords)
                            @foreach(explode(',', $$module_name_singular->meta_keywords) as $keyword)
                                <span class="badge bg-info text-dark">{{ trim($keyword) }}</span>
                            @endforeach
                        @else
                            -
                        @endif
